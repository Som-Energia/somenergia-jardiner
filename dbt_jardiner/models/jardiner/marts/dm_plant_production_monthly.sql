...
select
  ...
  round((sum(energia_exportada_instantania_comptador_kwh) / 1000.0)::numeric, 1) as energia_exportada_instantania_comptador_mwh,
  count(energia_exportada_instantania_comptador_kwh) as energia_exportada_instantania_comptador_count,
  round((sum(energia_exportada_comptador_kwh) / 1000.0)::numeric, 1) as energia_exportada_comptador_mwh,
  round((sum(energia_importada_comptador_kwh) / 1000.0)::numeric, 1) as energia_importada_comptador_mwh,
  --min(data_prediccio) as data_prediccio,
  round((sum(energia_predita_meteologica_kwh) / 1000.0)::numeric, 1) as energia_predita_meteologica_mwh,
  round((sum(energia_esperada_solargis_kwh) / 1000.0)::numeric, 1) as energia_esperada_solargis_mwh,
  ...
  round((sum(energia_desviada_omie_kwh) / 1000.0)::numeric, 1) as energia_desviada_omie_mwh,
  ...
  round((sum(energia_perduda_kwh) / 1000.0)::numeric, 1) as energia_perduda_mwh,
